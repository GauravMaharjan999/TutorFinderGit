...
namespace Kachuwa.KLiveApp.Controllers
{
    public class FileController : Controller
    {
        ...
        public FileController(IHostingEnvironment hostingEnvironment, IStorageProvider storageProvider, ILogger logger, ICacheService cacheService, IServerService serverService)
        {
